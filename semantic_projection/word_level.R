...
ggsave(file.path(semantic_dir, "semantic_projection_final.pdf"), plot = p, width = 10, height = 8)
...
write.csv(sig_df, file.path(semantic_dir, "significant_pairwise_findings.csv"), row.names = FALSE)
