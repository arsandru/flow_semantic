...
word_level_df.to_csv(OUTPUT_DIR / "semantic_projection_qwen.csv", index=False)
participant_level_df.to_csv(OUTPUT_DIR / "semantic_projection_qwen_mean.csv", index=False)
...
label_df.to_csv(OUTPUT_DIR / "semantic_projection_qwen_plot_labels.csv", index=False)
...
plt.tight_layout()
plt.savefig(OUTPUT_DIR / "semantic_projection_qwen.pdf", format="pdf")
plt.savefig(OUTPUT_DIR / "semantic_projection_qwen.svg", format="svg")
plt.show()
