...
input_path <- file.path(explore_dir, "semantic_projection_gemini.csv")
...
analyze_file <- function(input_path) {
  ...
  data$is_relief_outlier <- data$projection_fear_vs_calm < lower_fence
  ...
  counts_out <- file.path(explore_dir, sprintf("distress_outlier_counts_%s.csv", suffix))
  pairwise_distress_out <- file.path(explore_dir, sprintf("distress_outlier_pairwise_fisher_%s.csv", suffix))
  pairwise_relief_out <- file.path(explore_dir, sprintf("relief_extreme_pairwise_fisher_%s.csv", suffix))
  distress_words_out <- file.path(explore_dir, sprintf("distress_outlier_words_%s.csv", suffix))
  relief_words_out <- file.path(explore_dir, sprintf("relief_extreme_words_%s.csv", suffix))
  report_out <- file.path(explore_dir, sprintf("distress_outlier_fisher_report_%s.txt", suffix))
