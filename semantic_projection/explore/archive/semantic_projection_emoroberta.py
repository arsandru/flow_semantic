...
def encode_word(w: str) -> np.ndarray:
    ...
    elif key in {"little_worried", "little worried"}:
        w = "a little worried"
    elif key in {"little_bothered", "little bothered"}:
        w = "a little bothered"
...
distress_words = [
    "distressed", "apprehensive", "anguish", "torment", "agitated"
]
relaxed_words = [
    "relieved", "comforted", "soothed", "reassured", "at ease"
]
