...
word_level_df.to_csv(OUTPUT_DIR / "semantic_projection_qwen_noinstruct.csv", index=False)
participant_level_df.to_csv(OUTPUT_DIR / "semantic_projection_qwen_noinstruct_mean.csv", index=False)
...
plot_df.to_csv(OUTPUT_DIR / "semantic_projection_qwen_noinstruct_plot_points.csv", index=False)
...
label_df.to_csv(OUTPUT_DIR / "semantic_projection_qwen_noinstruct_plot_labels.csv", index=False)
...
plt.title("Semantic Projection of Emotional Words on Distress-Relaxed Axis (Qwen3)", fontsize=18)
...
plt.tight_layout()
plt.savefig(OUTPUT_DIR / "semantic_projection_qwen_noinstruct.pdf", format="pdf")
plt.savefig(OUTPUT_DIR / "semantic_projection_qwen_noinstruct.svg", format="svg")
plt.show()
